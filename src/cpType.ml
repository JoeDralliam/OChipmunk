...
and constraint' = 
    {
      ...
      cpresolve:constraint' presolve_func option;
      cpostsolve:constraint' postsolve_func option
    }
and space' =
    {
  ...
  (* private fields *)
        ...
        mutable spcontact_buffers_head:ContactBuffer.t option;
